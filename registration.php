                ...
                <div class="span8">
                    ...
                    <div class="tab-content">
                        <div id="patient" class="tab-pane fade in active">
                            <form action="controller/processRegistration.php" method="post" role="form" id="patient_form" class="contactForm">
                                <div class="row">
									...
									<label>Contact No</label>
                                        <input type="number" name="mobile" placeholder="Enter your Contact No" id="mobile"  autocomplete="off" required>
                                        <div class="validation"></div>
                                    </div>
                                    <div class="span4 form-group">
									<label>Email</label>
                        ...
                        <div id="doctor" class="tab-pane fade">
                            <form action="controller/doctorRegistration.php" method="post" enctype="multipart/form-data" id="doctor_form" role="form" class="contactForm">
                                <div class="row">
                                    <div class="span8 form-group field">
                                        <label>Full Name</label>
                                    ...
                                    <div class="span4 form-group">
									<label>Contact No</label>
                                        <input type="number" name="mobile" placeholder="Enter your Contact No" id="mobile1"  autocomplete="off" required>
                                        <div class="validation"></div>
                                    </div>
                                    <div class="span8 form-group">
                                    ...
                                    <div class="span4 form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Enter Bkash Merchant Number" id="bkash" name="bkash_merchant_no"  autocomplete="off" required>
                                        <div class="validation"></div>
