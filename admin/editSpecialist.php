...
$mdata=$obj->singleRowData($_GET['id']);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="span12">
                <div class="inner-heading">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><h6>Update Specialist</h6></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="span8">
                    ...
                    <form action="../controller/UpdateSpecialist.php" method="post" role="form" class="contactForm">
                        <div class="row">
                            <div class="span8 form-group field">
                                <label>Specialist Name</label>
                                <input type="text" class="form-control" placeholder="Specialist Name" name="specialist" required value="<?php echo $mdata->specialist ?>">
                                <div class="validation"></div>
                            </div>
                            
                            <div class="span8 form-group">
                                <div class="text-center">
                                    <input type="hidden" name="specialist_id" value="<?php echo $mdata->specialist_id?>" readonly>
