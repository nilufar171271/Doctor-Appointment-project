    ...
    <header>
        <div class="top">
            <div class="container">
                <div class="row">
                    <div class="span6">
                        <p class="topcontact"><i class="icon-phone"></i> +88 01700821684</p>
                    </div>
                    <div class="span6">
        ...
        <div class="container">
            <div class="row nomargin">
                <div class="span4">
                    <div class="logo">
                        <a href="index.php"><img src="resources/img/logo(1).png" alt="" /></a>
                    </div>
                </div>
                <div class="span8">
            ...
            <div class="row">
                ...
                <div class="span4">
                    <div class="widget">
                        ...
                        <address>
                            <strong>International Islamic University Chittagong</strong><br>
                            Kumira,Chittagong<br>
                        </address>
                        <p>
                            <i class="icon-phone"></i>01700821684 <br>
                            <i class="icon-envelope-alt"></i>nilufaryasmin409@gmail.com
                        </p>
                    </div>
                </div>
                <div class="span4">
                    <div class="widget">
                        <h5 class="widgetheading">Subscribe Us</h5>
                        <p>
                            Keep updated for new releases and freebies. Enter your e-mail and subscribe us.
                        </p>
        ...
        <div id="sub-footer">
            <div class="container">
                <div class="row">
                    <div class="span6">
                        <div class="copyright">
                            <p><span>&copy; IIUC, Batch 44 & 45. All right reserved</span></p>
                        </div>
                    ...
                    <div class="span6">
                        <div class="credits">
                            ...
                            -->
                            Designed by <a href="#/">Nilufar Yasmin Neela & Mahjuba Iqbal Mahin</a>
                        </div>
                    </div>
                </div>
            </div>
